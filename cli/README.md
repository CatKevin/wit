...
- `status` and `add` work: they hash files (sha256-base64), update `.wit/index`, and report workspace vs index state; respects `.gitignore`/`.witignore` patterns, and `add <dir>` recurses.
